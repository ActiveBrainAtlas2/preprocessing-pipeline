...
class Brain:
    """Basic class for quering attributes of Cell Detection, 
    contour processing and atlas creation
    """
    ...
    def get_shared_coms(self, com_dictionary1, com_dictionary2):
        ...
        """
        shared_structures = set(com_dictionary1.keys()).intersection(
            set(com_dictionary2.keys())
        )
