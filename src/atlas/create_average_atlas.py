...
from lib.utilities_atlas import volume_to_polydata, save_mesh_stl, \
...
for animal in tqdm(moving_brain_names):
    ...
    moving_brain = load_all_structures_and_origins(animal, atlas_resolution,ATLAS, structures=structures, in_bbox_wrt='wholebrain')
...
for structure in tqdm(structures):
    ...
    for i in range(1, len(instance_volumes)):
        ...
        _, _ = aligner.optimize(tf_type='rigid',
                                history_len=100,
                                max_iter_num=100 if structure in ['SC', 'IC'] else 1,
