...
def resize_helper(img, dst, resizef):
    ...
    tif.imwrite(os.path.join(dst, os.path.basename(img)), 
                    im.astype("uint16"))
...
if __name__ == "__main__":
    ...
    atlpth = "/home/eddyod/.brainglobe/sagittal_atlas_20um_iso.tif"
    ...
    tif.imwrite(os.path.join(os.path.dirname(dst), "downsized_for_atlas.tif"), arrsagd.astype("uint16"))
