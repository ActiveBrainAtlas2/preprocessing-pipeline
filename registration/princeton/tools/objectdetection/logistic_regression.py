...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  5 17:34:05 2018
...
#%%
def logistic_regression(tps, fps, penalty='l2', dual=False, tol=0.0001, C=1.0, fit_intercept=True, intercept_scaling=1, class_weight=None, random_state=None, solver='liblinear', max_iter=100, multi_class='ovr', cores = 10, kfold_splits = 10, dst = False, balance=False, precision_score='micro', warm_start=True, verbose=True, test_size=0.1):
    '''
    ...
    for train_index, test_index in gen.split(X, y):
        ...
        lr = LogisticRegression(penalty=penalty, dual=dual, tol=tol, C=C, fit_intercept=fit_intercept, intercept_scaling=intercept_scaling, class_weight=class_weight, random_state=random_state, solver=solver, max_iter=max_iter, multi_class=multi_class, verbose=0, warm_start=warm_start, n_jobs=cores)
