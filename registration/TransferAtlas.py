...
def main():
    ...
    atlas_image_fname = registration_pipeline_dir + '/ATLAS/annotation_10.vtk'
    ...
    sitk.WriteImage(registerd, registration_pipeline_dir + '/data/deformedAtlas/' + BRAINNO + '_downsample_regANNO_10.img')
