...
from utilities.imported_atlas_utilities import create_alignment_specs, load_transformed_volume, load_json, get_structure_contours_from_structure_volumes_v3
...
#         str_alignment_spec = load_json(fn_vis_structures)[structure]
    ...
    registered_atlas_structures_wrt_wholebrainXYcropped_xysecTwoCorners = \
            load_json(os.path.join(fileLocationManager.brain_info, 'registered_atlas_structures_wrt_wholebrainXYcropped_xysecTwoCorners.json'))
