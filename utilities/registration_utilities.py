...
from utilities2015 import load_hdf, find_contour_points, consolidate, rescale_by_resampling
from metadata import (all_known_structures_sided, 
                      convert_to_left_name, convert_to_right_name,
                      convert_resolution_string_to_voxel_size, convert_to_surround_name,  convert_to_nonsurround_name, 
                      convert_to_original_name,
                      is_sided_label, is_surround_label, 
...
def find_z_section_map(stack, volume_zmin, downsample_factor = 16):
    xy_pixel_distance_lossless = 0.46 # this was taken from utilities2015 3/23/2020 EOD
