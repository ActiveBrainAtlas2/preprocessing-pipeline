...
from pipeline.utilities.utilities_atlas import load_original_volume_all_known_structures_v3, get_centroid_3d, \
    ...
    load_mean_shape
from pipeline.lib.atlas_aligner import Aligner
