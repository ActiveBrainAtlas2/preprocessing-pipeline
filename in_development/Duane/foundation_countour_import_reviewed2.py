...
def main():
    ...
    for index, row in contours.iterrows():
        ...
        output = ""
        for structure_name, dict_section_x_y_pairs in contour_per_structure_per_section.items():
            ...
            for sectioni, contour_points_sectioni in dict_section_x_y_pairs.items():
                ...
                print(sectioni, len(contour_points_sectioni))#, contour_points_sectioni)
