...
class init_GUI(QWidget):
    ...
    def initUI(self):
        ...
        self.e1.setText( "Crop Step: Main Page" )
        self.e1.setFrame( False )
        self.grid_top.addWidget( self.e1, 0, 0)

        ### Grid Buttons ###
        # Button
        self.b_1 = QPushButton("1) Find Brainstem Cropping Box")
        ...
        self.setWindowTitle("Find the Brainstem's Cropbox")
    ...
    def button_grid_push(self, button):
        ...
        if button == self.b_1:
            subprocess.call(['python','a_GUI_crop_brainstem.py', self.stack])
