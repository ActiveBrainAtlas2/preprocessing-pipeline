...
This gets run after aligment1.py
"""
import os
import sys
...
filepath = '/mnt/data/CSHL_data_processed/{}/{}_thumbnail_NtbNormalized'.format(stack, stack)
...
custom_output_dir = '/mnt/data/CSHL_data_processed/{}/{}_custom_output'.format(stack,stack)
toanchor_transforms_fp = '/mnt/data/CSHL_data_processed/{}/{}_transforms_to_anchor.csv'.format(stack,stack)
