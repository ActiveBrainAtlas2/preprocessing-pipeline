...
--
-- Table structure for table `atlas_coms`
--
...
CREATE TABLE `atlas_coms` (
  `abbreviation` varchar(25) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `structure_id` int(11) NOT NULL,
  `x` double(17,0) DEFAULT NULL,
  `y` double(17,0) DEFAULT NULL,
  `section` double(17,0) NOT NULL
...
CREATE TABLE `center_of_mass` (
  ...
  KEY `K__COM_ITID` (`input_type_id`),
  CONSTRAINT `FK__COM_ITID` FOREIGN KEY (`input_type_id`) REFERENCES `com_type` (`id`),
  CONSTRAINT `FK__COM_PID` FOREIGN KEY (`person_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `FK__COM_TID` FOREIGN KEY (`transformation_id`) REFERENCES `transformation` (`id`),
...
--
-- Table structure for table `detected_soma`
--

DROP TABLE IF EXISTS `detected_soma`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `detected_soma` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `prep_id` varchar(20) NOT NULL,
  `x` float DEFAULT NULL,
  `y` float DEFAULT NULL,
  `z` float NOT NULL DEFAULT 0,
  `detection` enum('sure','unsure') DEFAULT NULL,
  `vetting` enum('yes','no') DEFAULT NULL,
  `active` tinyint(1) DEFAULT NULL,
  `created` datetime(6) NOT NULL,
  `updated` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `K__DS_AID` (`prep_id`),
  CONSTRAINT `FK__DS_AID` FOREIGN KEY (`prep_id`) REFERENCES `animal` (`prep_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `foundation_coms`
--
...
CREATE TABLE `foundation_coms` (
  ...
  `x` double(17,0) DEFAULT NULL,
  `y` double(17,0) DEFAULT NULL,
  `section` double(17,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `layer_data_history`
--
...
CREATE TABLE `layer_data_history` (
  ...
  `person_id` int(11) NOT NULL,
  `input_type_id` int(11) NOT NULL DEFAULT 1,
  `layer` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `x` float DEFAULT NULL,
  `y` float DEFAULT NULL,
  `section` float NOT NULL DEFAULT 0,
  `active` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `table_metadata` (
  ...
  `entry` longtext NOT NULL DEFAULT '',
  ...
  `updated` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `K__table_metadata_tname` (`table_name`)
