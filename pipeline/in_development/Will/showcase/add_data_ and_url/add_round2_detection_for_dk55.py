...
import numpy as np
animal = 'DK55'
round2_cell_detection_result = pd.read_csv('/net/birdstore/Active_Atlas_Data/cell_segmentation/DK55/detections/detections_DK55_round2.csv')
...
for _,celli in cells.iterrows():
    ...
    controller.add_layer_data_row(animal,34,1,coord,52,'detected_soma_round2_sure')
