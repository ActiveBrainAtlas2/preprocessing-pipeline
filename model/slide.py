...
class Slide(Base, AtlasModel):
    ...
    scene_qc_4 = Column(Enum("Out-of-Focus", "Bad tissue", "End"), nullable=True)
    scene_qc_5 = Column(Enum("Out-of-Focus", "Bad tissue", "End"), nullable=True)
    scene_qc_6 = Column(Enum("Out-of-Focus", "Bad tissue", "End"), nullable=True)
